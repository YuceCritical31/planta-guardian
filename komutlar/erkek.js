...
.setColor('BLUE')
.setDescription(` ${member} **Adlı üyeye** <@756798079859949588> rolünü verip ismini \`乡 ${isim} | ${yaş}\` **olarak ayarladım**
                 \n <a:sagok:757855573554233396> Toplam Yaptığın Kayıt Sayısı: **${kayıtsayı ? `${kayıtsayı}` : "0"}**`)
