...
function guvenli(kisiID) {
  ...
  let guvenli = []; if (!uye || uye.id === client.user.id || uye.id === ayarlar.owner || uye.id === ayarlar.baran || uye.id === ayarlar.efe ||  uye.id === ayarlar.kaya || uye.id === ayarlar.modbot || uye.id === ayarlar.koruma || uye.id === uye.guild.owner.id || guvenli.some(g => uye.id === g.slice(1) || uye.roles.cache.has(g.slice(1)))) return true
  else return false;
};
